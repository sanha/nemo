...
public final class JobConf extends ConfigurationModuleBuilder {
   ...
   */
  @NamedParameter(doc = "Hash range multiplier", short_name = "hash_range_multiplier", default_value = "1.5")
  public final class HashRangeMultiplier implements Name<Double> {
  }
