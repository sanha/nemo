 ...
 */
public final class DataSkewRuntimePassForSailfish implements RuntimePass<Pair<List<String>, Map<Integer, Long>>> {
  private static final Logger LOG = LoggerFactory.getLogger(DataSkewRuntimePassForSailfish.class.getName());
   ...
   * Constructor.
   */
  public DataSkewRuntimePassForSailfish() {
    this.eventHandlers = Collections.singleton(DynamicOptimizationEventHandler.class);
    this.numSkewedKeys = DEFAULT_SKEWED_KEYS;
  }

  public DataSkewRuntimePassForSailfish(final int numOfSkewedKeys) {
    this();
    this.numSkewedKeys = numOfSkewedKeys;
  }

  public DataSkewRuntimePassForSailfish setNumSkewedKeys(final int numOfSkewedKeys) {
