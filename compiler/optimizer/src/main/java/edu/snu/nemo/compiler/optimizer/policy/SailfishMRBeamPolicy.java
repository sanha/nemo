...
import edu.snu.nemo.compiler.optimizer.pass.compiletime.annotating.MRBeamCoderPass;
 ...
 */
public final class SailfishMRBeamPolicy implements Policy {
  private final Policy policy;

  /**
   * Default constructor.
   */
  public SailfishMRBeamPolicy() {
    this.policy = new PolicyBuilder(false)
        .registerCompileTimePass(new MRBeamCoderPass())
