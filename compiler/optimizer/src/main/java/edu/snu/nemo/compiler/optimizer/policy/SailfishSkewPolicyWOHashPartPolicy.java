...
import edu.snu.nemo.compiler.optimizer.pass.compiletime.sailfishskew.DataSkewCompositePassForSailfishWOPart;
 ...
 */
public final class SailfishSkewPolicyWOHashPartPolicy implements Policy {
  private final Policy policy;

  /**
   * Default constructor.
   */
  public SailfishSkewPolicyWOHashPartPolicy() {
    this.policy = new PolicyBuilder(false)
        ...
        .registerRuntimePass(new DataSkewRuntimePassForSailfish(), new DataSkewCompositePassForSailfishWOPart())
