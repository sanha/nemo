...
public final class SamplingSkewMetricCollectionPass extends AnnotatingPass {
  /**
   * Default constructor.
   */
  public SamplingSkewMetricCollectionPass() {
    super(SamplingSkewMetricCollectionPass.class);
  }
